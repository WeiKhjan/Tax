...
ws_pbc['A1'] = "PBC LIST - [CLIENT COMPANY NAME] ([COMPANY NUMBER])"
...
ws_pbc['A2'] = "YA [YEAR] | Basis Period: [START DATE] to [END DATE] | STATUS: SUBSTANTIALLY COMPLETE"
...
pbc_items = [
    ("A. STATUTORY & CORPORATE DOCUMENTS", [
        ("A1", "SSM Company Profile / Business Registration", "RECEIVED", "Feb 2025", "Co. No: [COMPANY NUMBER]", "Section 14.pdf"),
        ("A2", "Certificate of Incorporation", "RECEIVED", "Feb 2025", "Incorporated: [DATE]", "Section 14.pdf"),
        ("A3", "Register of Directors", "RECEIVED", "Feb 2025", "[DIRECTOR NAME] - [NRIC]", "Section 14.pdf"),
        ("A4", "Register of Shareholders / Members", "RECEIVED", "Feb 2025", "[SHAREHOLDER NAME] - 100 shares (100%)", "Section 14.pdf"),
        ("A5", "Register of Beneficial Owners", "RECEIVED", "Feb 2025", "[BO NAME] - 100% Direct", "[BO DOC].pdf"),
    ]),
    ("B. TAX REGISTRATION", [
        ("B1", "LHDN Tax Registration", "RECEIVED", "Feb 2025", "Tax File: C [TAX FILE NO]", "LHDN EMAIL.pdf"),
        ("B2", "Employer Registration", "RECEIVED", "Feb 2025", "Employer No: E [EMPLOYER NO]", "LHDN EMAIL.pdf"),
        ("B3", "CP204 Submission for YA 2025", "PENDING", "", "To verify if submitted", ""),
    ]),
    ("C. DIRECTORS INFORMATION (Schedule C)", [
        ("C1", "Director's full name", "RECEIVED", "Feb 2025", "[DIRECTOR NAME]", "Section 14.pdf"),
        ("C2", "Director's NRIC (12 digits)", "RECEIVED", "Feb 2025", "[NRIC]", "Section 14.pdf"),
        ("C3", "Director's residential address", "RECEIVED", "Feb 2025", "[ADDRESS]", "[DOC REF].pdf"),
        ("C4", "Director's date of appointment", "RECEIVED", "Feb 2025", "[DATE]", "[DOC REF].pdf"),
        ("C5", "Director's email", "RECEIVED", "Feb 2025", "[EMAIL]", "Section 14.pdf"),
    ]),
    ("D. SHAREHOLDERS INFORMATION (Schedule D)", [
        ("D1", "List of all shareholders", "RECEIVED", "Feb 2025", "[SHAREHOLDER NAME] - 100%", "Section 14.pdf"),
        ("D2", "Shareholder NRIC", "RECEIVED", "Feb 2025", "[NRIC]", "Section 14.pdf"),
        ("D3", "Corporate shareholder details", "RECEIVED", "Feb 2025", "NONE - 100% individual", "Section 14.pdf"),
    ]),
    ("E. BENEFICIAL OWNERSHIP (Schedule E)", [
        ("E1", "BO Declaration Form", "RECEIVED", "Feb 2025", "Section 56 declaration", "[BO DOC].pdf"),
        ("E2", "BO Name & NRIC", "RECEIVED", "Feb 2025", "[BO NAME] - [NRIC]", "[BO DOC].pdf"),
        ("E3", "Date became BO", "RECEIVED", "Feb 2025", "[DATE]", "[BO DOC].pdf"),
    ]),
]
...
wb_pbc.save(f"{output_dir}/PBC_Checklist_UPDATED.xlsx")
...
ws_qry['A1'] = "TAX QUERY LIST - [CLIENT COMPANY NAME] ([COMPANY NUMBER])"
...
wb_qry.save(f"{output_dir}/Query_List_UPDATED.xlsx")
