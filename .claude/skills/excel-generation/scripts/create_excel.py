...
pbc_data = [
    ...
    ("F1", "List of related companies", "Medium", "Pending", "Tarom Enterprise relationship"),
...
query_data = [
    ("Q001", "A/C 5100/0000\nRental Income", "43,600.00",
     ...
     ""),
    ("Q002", "A/C 3501/0000\nTarom Enterprise Sdn Bhd", "170,000.00",
     "Please clarify:\n\n1. Is this an interest-free loan?\n2. What is the relationship between Jati Kirana and Tarom Enterprise?\n3. Is Tarom Enterprise a shareholder of Jati Kirana?\n4. What is Tarom Enterprise's paid-up capital?",
     "IMPORTANT: If Tarom Enterprise's paid-up capital exceeds RM 2.5 million, Jati Kirana will NOT qualify for SME tax rates.\n\nIf related party, transactions must be at arm's length (Section 140A).",
     ""),
    ("Q003", "A/C 4100/0001 & 4100/0002\nAmounts Owing to Directors", "69,923.87",
     "Please confirm:\n\n1. Are the directors' advances interest-free?\n2. Is there any formal loan agreement?\n3. When are these amounts intended to be repaid?\n\nDirectors:\n- Michael Chew Soon Sian: RM 39,923.87\n- Nicolas Chew: RM 30,000.00",
